...
<div class="relative overflow-x-auto sm:rounded-lg">
    <div class="pb-4 flex justify-end">
        ...
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
            class="block text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
            type="button">
            Add user
        </button>
                        ...
                        <div class="grid gap-4 mb-4 grid-cols-4">
                            ...
                            <div class="col-span-1">
                                <label for="phone_number"
                                    class="block mb-2 text-sm font-medium text-gray-600">Phone</label>
                                <input type="text" name="phone_number"
                                    class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                    placeholder="628124123">
                            </div>
                            <div class="col-span-1 ">
                            ...
                            <div class="col-span-2">
                                <label for="password_confirm"
                                    class="block mb-2 text-sm font-medium text-gray-600">Password Confirmation</label>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500" id="pagination-table">
        ...
        <tbody>
            ...
            <tr class="bg-blue-900 border-b hover:bg-blue-700 text-white">
                ...
                <td class="px-6 py-4 flex justify-start items-center ">
                    <a data-modal-target="edit-modal-<?= $user['id'] ?>"
                        data-modal-toggle="edit-modal-<?= $user['id'] ?>" href="#"
                        class="font-medium text-white hover:underline mr-2">
                        <svg class="w-4 h-4 md:w-5 md:h-5 text-gray-800 dark:text-white" aria-hidden="true"
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <form class="p-4 md:p-5" method="post">
                                    ...
                                    <div class="grid gap-4 mb-4 grid-cols-4">
                                        <div class="col-span-2">
                                            <label for="nik"
                                                class="block mb-2 text-sm font-medium text-gray-600">NIK</label>
                                            <input type="text" value="<?= $user['nik'] ?>" readonly name="nik"
                                                class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                                placeholder="1294012094712">
                                        </div>
                                        <div class="col-span-2">
                                            <label for="username"
                                        ...
                                        <div class="col-span-2">
                                            <label for="name"
                                                class="block mb-2 text-sm font-medium text-gray-600">Name</label>
                                        ...
                                        <div class="col-span-1 ">
                                            <label for="role_id"
                                                class="block mb-2 text-sm font-medium text-gray-600">Role</label>
                                            <select name="role_id"
                                        ...
                                        <div class="col-span-1">
                                            <label for="old_password"
                                                class="block mb-2 text-sm font-medium text-gray-600">Old
                                                Password</label>
                                            <input minlength="8" type="password" name="old_password"
                                                class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                                placeholder="**************">
                                        </div>
                                        <div class="col-span-1">
                                        ...
                                        <div class="col-span-2">
                                            <label for="password_confirm"
                                                ...
                                                Confirmation</label>
                                            <input minlength="8" type="password" name="password_confirm"
                                                class="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                                                placeholder="**************">
                                        </div>
                                    </div>
                                    <div class="flex justify-end">
                                        <button name="update" type="submit"
                                            class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                            <svg class="me-1 -ms-1 w-5 h-5 text-gray-800 dark:text-white"
                    ...
                    <a href="#" onclick="confirmDelete('users_delete', 'user_id',<?= $user['id'] ?>)"
