...
<div class="relative overflow-x-auto sm:rounded-lg mt-10">
    <table class="w-full text-sm text-left rtl:text-right text-gray-500" id="pagination-table">
        ...
        <tbody>
            ...
            <tr class="bg-blue-900 border-b hover:bg-blue-800 text-white">
                ...
                <td class="px-6 py-4 flex justify-start items-center ">
                    ...
                    <a href="#" onclick="confirmApprove('reports_approve', 'id', <?= $report['id'] ?>)"
                        class="font-medium text-white hover:underline">
                        <svg class="mr-4 w-4 h-4 md:w-5 md:h-5 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <a href="index.php?page=detail&id=<?= $report['id'] ?>"
                        class="font-medium text-white hover:underline">
                        <svg class="mr-4 w-4 h-4 md:w-5 md:h-5 text-gray-800 dark:text-white" aria-hidden="true"
                    ...
                    <a href="#" onclick="confirmDelete('reports_delete', 'id',<?= $report['id'] ?>)"
                        class="font-medium text-white hover:underline">
