<div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
    <div class="card shadow-xl col-span-1 md:col-span-4  rounded-lg border-gray-300 dark:border-gray-600 h-auto mb-4">
        <form class="py-5 px-6" method="post" enctype="multipart/form-data">
            <div class="space-y-12">
                <div class=" pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="col-span-full">
                            <label for="thumbnail"
                                class="block text-sm/6 font-medium text-gray-900 mb-3">Thumbnail</label>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button name="submit" type="submit"
                    class="rounded-md bg-blue-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
            </div>
        </form>
